                        ...
                        <>
                            ...
                            <div className={styles.modalHolder}>
                                <article className={styles.modal}>
                                    ...
                                    {(this.props.event.filmed) ? <a className={styles.buttonOutline} target="blank" href="https://civilservice.govintra.net/live-event/fset-webcast/">Go to live stream</a> : null}
